...
print('When applying the min/max/mean/median brigthness temperature ratio, the corresponding optical depth of tracer in %s.fits:' %(fitsfile1))
print('(1): %f; (2): %f; (3): %f; (4): %f' %(tau1[index1], tau1[index2], tau1[index3], tau1[index4]))
print('When applying the min/max/mean/median brigthness temperature ratio, the corresponding optical depth of tracer in %s.fits:' %(fitsfile2))
print('(1): %f; (2): %f; (3): %f; (4): %f' %(tau2[index1], tau2[index2], tau2[index3], tau2[index4]))
# print('optical depth of tracer in %s.fits:' %(fitsfile1))
# print('min: %f; max: %f; mean: %f; median: %f' %(np.nanmin(tau1_dat), np.nanmax(tau1_dat), np.nanmean(tau1_dat), np.nanmedian(tau1_dat)))
# print('optical depth of tracer in %s.fits:' %(fitsfile2))
